...
<script lang="ts">
import { FactionGenerator } from '@/logic/faction/FactionGenerator'
import factionTemplates from '@/assets/data/faction/templates.json'
...
export default Vue.extend({
  ...
  methods: {
    async getFaction(template: any) {
      this.loading = true
      this.outputRaw = await new FactionGenerator().Generate(template)
